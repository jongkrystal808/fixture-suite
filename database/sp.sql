...
CREATE DEFINER = fixture_test@`%`
PROCEDURE sp_material_receipt(
...
proc_end: BEGIN
    ...
    IF p_record_type = 'datecode' THEN
        ...
        INSERT INTO fixture_datecode_inventory (
            ...
            p_customer_id, p_fixture_id, p_datecode, CAST(p_serials_csv AS UNSIGNED)
        )
        ...
        INSERT INTO fixture_datecode_transactions (
            ...
            p_transaction_id, p_customer_id, p_fixture_id, p_datecode, 'receipt',
            CAST(p_serials_csv AS UNSIGNED)
        );

        INSERT INTO material_transaction_items (
            transaction_id, customer_id, fixture_id, datecode, quantity
        ) VALUES (
...
proc_end: BEGIN
    ...
    WHILE LENGTH(p_serials_csv) > 0 DO
        ...
        IF v_serial <> '' THEN
            ...
            INSERT INTO material_transaction_items (
                transaction_id, customer_id, fixture_id, serial_number
            ) VALUES (
                p_transaction_id, p_customer_id, p_fixture_id, v_serial
            );
        END IF;
    END WHILE;
END$$
...
proc_end: BEGIN
    ...
    IF p_record_type = 'datecode' THEN
        ...
        SET available_qty = available_qty - CAST(p_serials_csv AS UNSIGNED),
            returned_qty  = returned_qty  + CAST(p_serials_csv AS UNSIGNED)
        WHERE customer_id = p_customer_id
          AND fixture_id  = p_fixture_id
        ...
        INSERT INTO fixture_datecode_transactions (
            ...
            p_transaction_id, p_customer_id, p_fixture_id, p_datecode, 'return',
            CAST(p_serials_csv AS UNSIGNED)
        );
