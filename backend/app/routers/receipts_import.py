"""
收料 Excel 匯入 Router（v6 OUT 版）
- 以 sp_material_receipt_v6 為唯一準則
- 11 IN + 2 OUT
    ...
    for idx, row in df.iterrows():
        ...
        try:
            ...
            if not out or not out.get("o_transaction_id"):
                raise ValueError(out.get("o_message") if out else "收料失敗")
